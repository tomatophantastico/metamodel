...
public class TableTypeTest extends TestCase {
    ...
    public void testGetTableType() throws Exception {
        ...
        assertSame(TableType.GLOBAL_TEMPORARY, TableType.getTableType("GLOBAL_TEMPORARY"));
        assertSame(TableType.SYSTEM_TABLE, TableType.getTableType("system_table"));
        assertSame(TableType.LOCAL_TEMPORARY, TableType.getTableType("LOCAL_TEMPORARY"));
