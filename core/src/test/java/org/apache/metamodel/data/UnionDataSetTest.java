...
public class UnionDataSetTest {
    ...
    public void testVanillaUnion() {
        ...
        final DataSetHeader header1 =
                new SimpleDataSetHeader(Lists.newArrayList(new MutableColumn("foo1"), new MutableColumn("bar1"))
                        .stream().map(SelectItem::new).collect(Collectors.toList()));
        ...
        final DataSetHeader header2 =
                new SimpleDataSetHeader(Lists.newArrayList(new MutableColumn("foo2"), new MutableColumn("bar2"))
                        .stream().map(SelectItem::new).collect(Collectors.toList()));
        ...
        final DataSetHeader header3 =
                new SimpleDataSetHeader(Lists.newArrayList(new MutableColumn("foo3"), new MutableColumn("bar3"))
                        .stream().map(SelectItem::new).collect(Collectors.toList()));
        ...
        final DataSetHeader unionHeader =
                new SimpleDataSetHeader(Lists.newArrayList(new MutableColumn("fooUnion"), new MutableColumn("barUnion"))
                        .stream().map(SelectItem::new).collect(Collectors.toList()));
