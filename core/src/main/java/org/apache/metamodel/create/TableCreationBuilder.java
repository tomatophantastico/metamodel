...
public interface TableCreationBuilder {
    ...
    /**
     * Builds this table's columns based on another {@link Table} which will be used as a prototype. Using this method
     * simplifies the creation of a table that is similar to an existing table.
     * 
    ...
    /**
     * Returns this builder instance as a table. This allows for inspecting the table that is being built, before it is
     * actually created.
     * 
    ...
    /**
     * Gets a SQL representation of this create table operation. Note that the generated SQL is dialect agnostic, so it
     * is not accurately the same as what will be passed to a potential backing database.
     * 
