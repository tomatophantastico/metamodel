...
public interface UpdateableDataContext extends DataContext {
     ...
     * 
     * Since implementations of the {@link DataContext} vary quite a lot, there is no golden rule as to how an update
     * script will be executed. But the implementors should strive towards handling an {@link UpdateScript} as a single
     * transactional change to the data store.
     * 
